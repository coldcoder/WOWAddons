...
function L.M.bag.OnEvent(self, e, ...)
  ...
  if (e == "ADDON_LOADED" and arg1 == A) then
    self:Update()
    L.LoadBindings()
  elseif (e == "ITEM_LOCK_CHANGED" or e == "BAG_OPEN" or e == "TRADE_SHOW" or e == "MERCHANT_SHOW" or e == "TRADE_SKILL_SHOW" or e == "AUCTION_HOUSE_SHOW" or e == "MAIL_SHOW" or e == "BANKFRAME_OPENED" or e == "BANK_BAG_SLOT_FLAGS_UPDATED") then
    for containerGroupId, container in pairs(self.containers) do
      L.M.container.DoShow(container)
    end
    if L.C.keyring and L.C.keyring.enabled then
